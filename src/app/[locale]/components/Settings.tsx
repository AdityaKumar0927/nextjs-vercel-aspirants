...
const QuestionBank: React.FC = () => {
  ...
  const filterQuestions = useCallback((filters: any) => {
  ...
  }, [questions, markedForReview, markedComplete]);
  ...
  }, [filters, markedForReview, markedComplete, filterQuestions]);
        ...
        <div className="bg-white p-4 rounded-md shadow-md flex flex-wrap gap-4">
          {filteredQuestions.map(question => (
            <Question
              ...
              handleOptionClick={(option: string) => handleOptionClick(question.questionId, option, question.correctOption)}
              handleNumericalSubmit={(userAnswer: string) => handleNumericalSubmit(question.questionId, userAnswer, question.correctOption)}
              handleNumericalChange={(value: string) => handleNumericalChange(question.questionId, value)}
